...
def resize_bbox(bbox, resize_factor, image_width, image_height):
    ...
    # Keep original aspect ratio instead of making it square
    # (This was causing all videos to be square even without --square flag)
    ...
    # Keep the clamped coordinates as they are (no forced squaring)
    # The coordinates are already clamped to image boundaries above
